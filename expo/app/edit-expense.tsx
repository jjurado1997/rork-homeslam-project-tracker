...
export default function EditExpenseScreen() {
  ...
  const { projectId, expenseId } = useLocalSearchParams();
  const { updateExpense, allProjects } = useProjects();
  ...
  const handleSave = () => {
    ...
    if (!expenseId || typeof expenseId !== 'string') {
      Alert.alert('Error', 'Invalid expense');
      return;
    }

    updateExpense(projectId, expenseId, {
      category,
